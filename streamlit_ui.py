...
from website_expert import website_expert, WebsiteDependents
...
async def main():
    ...
    user_input = st.chat_input("What questions do you have about this website?")
